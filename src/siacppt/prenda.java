...
public class prenda extends javax.swing.JFrame {
    ...
    void inser(){
        ...
        b=this.prenda.getText();
        sql="insert into tipo_prenda values(?,?)";
        try {
    ...
    private void initComponents() {
        ...
        prenda = new org.edisoncor.gui.textField.TextFieldRectBackground();
        ...
        jLabel53.setText("nombre de la prenda");
        ...
        prenda.setDescripcion("uauario");

        jLabel54.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        jLabel54.setText("codigo de la prenda");
            ...
            .addGroup(panelagujaLayout.createSequentialGroup()
                ...
                .addGroup(panelagujaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(panelagujaLayout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(prenda, javax.swing.GroupLayout.DEFAULT_SIZE, 100, Short.MAX_VALUE))
                    .addGroup(panelagujaLayout.createSequentialGroup()
    ...
    private org.edisoncor.gui.textField.TextFieldRectBackground prenda;
